...
class PopplerConan(ConanFile):
    ...
    def requirements(self):
        ...
        if self.options.with_libcurl:
            ...
            self.requires("libcurl/[>=8.16.0 <9]", transitive_headers=True, transitive_libs=True)
    ...
    def build_requirements(self):
        ...
        self.tool_requires("cmake/[>=3.31.9 <4]")
    ...
    def generate(self):
        ...
        tc.variables["POPPLER_DATADIR"] = self.dependencies["poppler-data"].cpp_info.resdirs[0].replace("\\", "/")
    ...
    def package_info(self):
        ...
        if self.options.with_tiff:
            ...
            # @TODO: hack
            self.cpp_info.components["libpoppler"].requires.append("libdeflate::libdeflate")
            self.cpp_info.components["libpoppler"].requires.append("jbig::jbig")
        if self.options.with_libcurl:
